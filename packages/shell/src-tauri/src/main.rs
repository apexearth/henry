...
// daemon already serves and gives the window a real menu, so ⌘N / Ctrl+N and ⌘1..9 reach
// the UI instead of being swallowed by the browser. Menu items arrive in the page as
