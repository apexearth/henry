...
export function FileView({ path, line, active, local = false, editable = false }: Props) {
  ...
  return (
    <div className={"peek" + (editing ? " editing" : "")}
      ...
      <div className="peek-head">
        {!local && <button className="peek-back" onClick={tryClose} title="back to the session (Esc)">←</button>}
